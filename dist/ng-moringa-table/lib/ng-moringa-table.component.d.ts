...
export declare class metricssTableComponent implements OnInit, OnChanges {
    data: any[];
    columns: {
        key: string;
        label: string;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<metricssTableComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<metricssTableComponent, "metrics-table", never, { "data": { "alias": "data"; "required": false; }; "columns": { "alias": "columns"; "required": false; }; "excludeColumns": { "alias": "excludeColumns"; "required": false; }; "actionButtons": { "alias": "actionButtons"; "required": false; }; "autoGenerateColumns": { "alias": "autoGenerateColumns"; "required": false; }; "filterBy": { "alias": "filterBy"; "required": false; }; "filterStyle": { "alias": "filterStyle"; "required": false; }; "searchButton": { "alias": "searchButton"; "required": false; }; "Sorting": { "alias": "Sorting"; "required": false; }; "pageSize": { "alias": "pageSize"; "required": false; }; "paginated": { "alias": "paginated"; "required": false; }; "showActions": { "alias": "showActions"; "required": false; }; "headerButtons": { "alias": "headerButtons"; "required": false; }; "collapsible": { "alias": "collapsible"; "required": false; }; "variant": { "alias": "variant"; "required": false; }; "metricsHeader": { "alias": "metricsHeader"; "required": false; }; "showFooter": { "alias": "showFooter"; "required": false; }; "icon": { "alias": "icon"; "required": false; }; "title": { "alias": "title"; "required": false; }; "sub": { "alias": "sub"; "required": false; }; "mediaImage": { "alias": "mediaImage"; "required": false; }; "nameLetters": { "alias": "nameLetters"; "required": false; }; "mediaStatus": { "alias": "mediaStatus"; "required": false; }; "idPrefix": { "alias": "idPrefix"; "required": false; }; "valueLenthColumns": { "alias": "valueLenthColumns"; "required": false; }; "progressBy": { "alias": "progressBy"; "required": false; }; "statusMap": { "alias": "statusMap"; "required": false; }; }, { "rowAction": "rowAction"; }, never, ["[header-component]", "[footer-component]"], true, never>;
}
export {};
