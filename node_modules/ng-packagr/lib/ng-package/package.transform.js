...
const watchTransformFactory = (project, options, analyseSourcesTransform, entryPointTransform) => (source$) => {
    ...
    return source$.pipe((0, rxjs_1.switchMap)(graph => {
        ...
        return onFileChange.pipe((0, rxjs_1.tap)(fileChange => {
            ...
            for (const { url } of allNodesToClean) {
                if ((0, nodes_1.isFileUrl)(url)) {
                    potentialStylesResources.add((0, nodes_1.fileUrlPath)(url));
                }
            }
            for (const entryPoint of graph.filter(nodes_1.isEntryPoint)) {
                let isDirty = !!((_b = (_a = entryPoint.cache.stylesheetProcessor) === null || _a === void 0 ? void 0 : _a.invalidate(potentialStylesResources)) === null || _b === void 0 ? void 0 : _b.length);
                isDirty || (isDirty = allNodesToClean.some(dependent => entryPoint.dependents.has(dependent)));
                if (isDirty) {
        ...
        }), (0, rxjs_1.debounceTime)(100), (0, rxjs_1.tap)(() => log.msg(FileChangeDetected)), (0, rxjs_1.startWith)(undefined), (0, rxjs_1.map)(() => graph));
