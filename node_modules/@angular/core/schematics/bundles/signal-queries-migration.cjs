...
var checker = require('./checker-DLkGMJj-.cjs');
var ts = require('typescript');
require('os');
var index$1 = require('./index-iQYWEThN.cjs');
require('path');
var project_paths = require('./project_paths-DePtMwan.cjs');
var apply_import_manager = require('./apply_import_manager-QEWElZT-.cjs');
var migrate_ts_type_references = require('./migrate_ts_type_references-BhOqwhYA.cjs');
var assert = require('assert');
var index = require('./index-BPwBW8Gv.cjs');
